document.addEventListener("DOMContentLoaded", () => {
    ...
    <img id="check-icon" src="./assets/images/check.svg" alt="check" class="w-5 h-5">
    </span>`,
    ...
    function togglePasswordVisibility() {
        ...
        const newIcon = inputType === "password" ? "./assets/images/eye-open.svg" : "./assets/images/eye-close.svg";
