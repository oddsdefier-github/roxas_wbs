...
class DataTable extends BaseQuery
{
    ...
    public function clientTable($dataTableParam)
    {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <td class="flex items-center px-6 py-4 space-x-3">
                <a href="client_profile_update.php?id=' . $clientID . '" type="button" title="View Client" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
