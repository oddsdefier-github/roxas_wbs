...
<div class="">
    <form id="clientProfileForm">
                ...
                <div class="mt-5 grid sm:grid-cols-6 grid-cols-1 gap-x-6 gap-y-8 ">
                    <div class="sm:col-span-6 grid grid-cols-6">
                        <div class="sm:col-span-1">
                            <label for="status" class="select-none block text-sm font-medium leading-6 text-gray-900">Status</label>
                            <div class="mt-2 relative">
                                <select id="status" name="status" class="block w-full rounded-md border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:max-w-xs sm:text-sm sm:leading-6">
                        ...
                        <div class="sm:col-span-6 grid grid-cols-6 gap-x-6 gap-y-8">
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2 relative">
                                    ...
                                    <input datepicker id="birthdate" name="birthdate" datepicker-autohide datepicker-title="Birthdate" type="text" class="pl-10 block w-full rounded-md border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6" placeholder="mm/dd/yyyy">
                                </div>
        ...
        <div class="mt-6 flex items-center justify-end gap-x-6">
            ...
            <button id="submit-update" class="flex gap-2 rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
...
<script src="./assets/js/clientProfileUpdate.js"></script>