        ...
        <div class="relative w-full max-w-md max-h-full">
            <div class="relative p-4 bg-white rounded-lg shadow">
                ...
                <div class="flex justify-end items-center p-4 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
                    ...
                    <button id="review_confirm" type="button" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" disabled>Confirm</button>
                </div>
