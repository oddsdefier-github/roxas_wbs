    ...
    <div>
        <div class="sticky z-40 top-0 mb-4 bg-white border-b border-gray-200 dark:border-gray-700">
            <ul class="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
                ...
                <li class="mr-2" role="presentation">
                    <button data-utils="load-table" data-current-page="1" class="inline-block p-4 text-blue-600 border-b-2 rounded-t-lg" id="dashboard-tab" data-tabs-target="#dashboard" type="button" role="tab" aria-controls="dashboard" aria-selected="false">Applicants</button>
                </li>
                <li class="mr-2" role="presentation">
