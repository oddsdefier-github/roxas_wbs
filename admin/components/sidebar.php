                ...
                <ul class="">
                    ...
                    <ul class="">
                        ...
                        <li>
                            ...
                            <ul class="hidden" id="tab-submenu">
                                <li class="rounded-md hover:text-indigo-300 hover:bg-indigo-400">
                                    <a href="clients.php" class="text-gray-100 w-full block px-10 py-3">Clients</a>
                                </li>
                                <li class="rounded-md hover:text-indigo-300 hover:bg-indigo-400">
                                    <a href="clients.php" class="text-gray-100 w-full block px-10 py-3">Personnel</a>
                                </li>
                                <li class="rounded-md hover:text-indigo-300 hover:bg-indigo-400">
                                    <a href="#" class="text-gray-100 w-full block px-10 py-3">Rates</a>
                                </li>
                            </ul>
                        ...
                        <li>
                            <a href="./logs.php" class="flex items-center justify-between gap-2 rounded-md px-3 py-3 hover:bg-indigo-400">
                                <span class="flex items-center gap-2">
