                        ...
                        <div class="sm:col-span-6 grid grid-cols-6 gap-x-6 gap-y-8">
                            <div class="sm:col-span-2">
                                ...
                                <div class="mt-2 relative">
                                    ...
                                    <input datepicker id="birthdate" name="birthdate" datepicker-autohide type="text" class="validate-input pl-10 block w-full rounded-md border-0 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-500 sm:text-sm sm:leading-6" placeholder="mm/dd/yyyy">
                                </div>
